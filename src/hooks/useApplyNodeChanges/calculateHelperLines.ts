 ...
 */
function checkNodeAlignment(
  nodeABounds: NodeBounds,
  nodeB: Node,
  currentResult: HelperLines
): HelperLines {
 ...
 */
function findAlignment(nodeABounds: NodeBounds, nodes: Node[], excludeId: string): HelperLines {
 ...
 */
export function calculateHelperLines(change: NodePositionChange, nodes: Node[]): HelperLines {
