...
export function EmptyState({ 
  message = 'Select or create a circuit to begin' 
}: EmptyStateProps) {
  ...
  return (
    <Box sx={containerStyle}>
      ...
      <Typography 
        ...
        sx={{ maxWidth: 400 }}
      >
        Use the circuit manager on the left to create a new circuit or select an existing one.
        Then use the editor to design your circuit and run analysis.
      </Typography>
    </Box>
  );
}
