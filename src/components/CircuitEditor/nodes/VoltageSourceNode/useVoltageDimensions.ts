/**
 * Hook for calculating voltage source dimensions based on rotation
 */

import { useMemo } from 'react';
import { useTheme } from '@mui/material';
import { getHandlePosition } from './helpers';
import { HANDLE_SIZE, HANDLE_BORDER_WIDTH, HORIZONTAL_WIDTH, HORIZONTAL_HEIGHT, VERTICAL_WIDTH, VERTICAL_HEIGHT } from './constants';

export const useVoltageDimensions = (rotation: number) => {
